# 📊 ai-credit-compliance (Java/Maven)
...
`ai-credit-compliance` is an enterprise credit scoring fairness compliance auditor for Spring Boot AI banking systems. It calculates Demographic Parity Ratio (DPR) and Equal Opportunity Difference (EOD) on lending decisions to ensure compliance with fair lending acts.
